...
pub use samplechain_runtime::RuntimeGenesisConfig;
pub use node_primitives::{AccountId, Balance, Signature};

type AccountPublic = <Signature as Verify>::Signer;

const STAGING_TELEMETRY_URL: &str = "wss://telemetry.polkadot.io/submit/";
const ENDOWMENT: Balance = 10_000_000 * SMPL;
// const STASH: Balance = ENDOWMENT / 1000;
const STASH: Balance = 50_000 * SMPL;


fn properties() -> Properties {
	let mut properties = Properties::new();
	properties.insert("tokenName".into(), "SampleCoin".into());
...
fn configure_accounts_for_staging_testnet() -> (
	...
	let mut endowed_accounts: Vec<(AccountId, Balance)> = vec![
		(root_key.clone(), 1_880_000 * SMPL),
		//1880000
	];

	initial_authorities.iter().for_each(|x| {
		endowed_accounts.push((x.0.clone(), 50_000 * SMPL));
	});
...
fn configure_accounts(
	...
	let mut endowed_accounts: Vec<(AccountId, Balance)> = endowed_accounts.unwrap_or_else(|| {
		vec![
			(get_account_id_from_seed::<sr25519::Public>("Alice"), 1_000_000 * SMPL),
			(get_account_id_from_seed::<sr25519::Public>("Bob"), 1_000_000 * SMPL),
			(get_account_id_from_seed::<sr25519::Public>("Charlie"), 1_000_000 * SMPL),
			(get_account_id_from_seed::<sr25519::Public>("Dave"), 1_000_000 * SMPL),
			(get_account_id_from_seed::<sr25519::Public>("Eve"), 1_000_000 * SMPL),
			(get_account_id_from_seed::<sr25519::Public>("Ferdie"), 1_000_000 * SMPL),
			(get_account_id_from_seed::<sr25519::Public>("Alice//stash"), 1_000_000 * SMPL),
			(get_account_id_from_seed::<sr25519::Public>("Bob//stash"), 1_000_000 * SMPL),
			(get_account_id_from_seed::<sr25519::Public>("Charlie//stash"), 1_000_000 * SMPL),
			(get_account_id_from_seed::<sr25519::Public>("Dave//stash"), 1_000_000 * SMPL),
			(get_account_id_from_seed::<sr25519::Public>("Eve//stash"), 1_000_000 * SMPL),
			(get_account_id_from_seed::<sr25519::Public>("Ferdie//stash"), 1_000_000 * SMPL),
		]
	});
	...
	let stakers = initial_authorities
		...
		.chain(initial_nominators.iter().map(|x| {
			...
			let nominations = initial_authorities
				...
				.collect::<Vec<_>>();
			(x.clone(), x.clone(),  0 * SMPL, StakerStatus::Nominator(nominations))
		}))
		.collect::<Vec<_>>();
...
pub fn testnet_genesis(
	...
	serde_json::json!({
		...
		"babe": {
			"epochConfig": Some(samplechain_runtime::BABE_GENESIS_EPOCH_CONFIG),
		},
		"society": { "pot": 0 },
		"assets": {
