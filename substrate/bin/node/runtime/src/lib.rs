...
pub const VERSION: RuntimeVersion = RuntimeVersion {
	spec_name: create_runtime_str!("smpl"),
	impl_name: create_runtime_str!("samplechain"),
...
parameter_types! {
	...
	pub const EnterDepositAmount: Balance = 2_000_000 * SMPL;
	pub const ExtendDuration: BlockNumber = 2 * HOURS;
	pub const ExtendDepositAmount: Balance = 1_000_000 * SMPL;
...
parameter_types! {
	pub const IndexDeposit: Balance = 1 * SMPL;
}
...
parameter_types! {
	pub const EXISTENTIAL_DEPOSIT: u128 = 1 * SMPL;
	pub const ExistentialDeposit: Balance = 1 * SMPL;
...
parameter_types! {
	...
	// signed config
	pub const SignedRewardBase: Balance = 1 * SMPL;
	pub const SignedFixedDeposit: Balance = 1 * SMPL;
...
parameter_types! {
	...
	pub const SubmissionDeposit: Balance = 100 * SMPL;
...
parameter_types! {
	...
	pub const MinimumDeposit: Balance = 100 * SMPL;
...
parameter_types! {
	pub const CandidacyBond: Balance = 10 * SMPL;
...
parameter_types! {
	...
	pub const TipReportDepositBase: Balance = 1 * SMPL;
...
parameter_types! {
	...
	pub const BountyValueMinimum: Balance = 5 * SMPL;
	pub const BountyDepositBase: Balance = 1 * SMPL;
	pub const CuratorDepositMultiplier: Permill = Permill::from_percent(50);
	pub const CuratorDepositMin: Balance = 1 * SMPL;
	pub const CuratorDepositMax: Balance = 100 * SMPL;
...
parameter_types! {
	pub const ChildBountyValueMinimum: Balance = 1 * SMPL;
}
...
impl pallet_tips::Config for Runtime {
	...
	type MaxTipAmount = ConstU128<{ 500 * SMPL }>;
...
parameter_types! {
	...
	pub const SubAccountDeposit: Balance = 2 * SMPL;   // 53 bytes on-chain
...
parameter_types! {
	pub const ConfigDepositBase: Balance = 5 * SMPL;
	pub const FriendDepositFactor: Balance = 50 * CENTS;
	pub const MaxFriends: u16 = 9;
	pub const RecoveryDeposit: Balance = 5 * SMPL;
}
...
parameter_types! {
	...
	pub const PeriodSpend: Balance = 500 * SMPL;
...
parameter_types! {
	pub const MinVestedTransfer: Balance = 100 * SMPL;
...
parameter_types! {
	pub const AssetDeposit: Balance = 100 * SMPL;
	pub const ApprovalDeposit: Balance = 1 * SMPL;
	pub const StringLimit: u32 = 50;
	pub const MetadataDepositBase: Balance = 10 * SMPL;
	pub const MetadataDepositPerByte: Balance = 1 * SMPL;
}
...
impl pallet_assets::Config<Instance1> for Runtime {
	...
	type AssetAccountDeposit = ConstU128<SMPL>;
...
parameter_types! {
	...
	pub const PoolSetupFee: Balance = 1 * SMPL; // should be more or equal to the existential deposit
...
parameter_types! {
	...
	pub const MinBid: Balance = 100 * SMPL;
...
parameter_types! {
	pub const CollectionDeposit: Balance = 100 * SMPL;
	pub const ItemDeposit: Balance = 1 * SMPL;
...
parameter_types! {
	pub const Budget: Balance = 10_000 * SMPL;
...
parameter_types! {
	...
	pub const MigrationSignedDepositBase: Balance = 20 * SMPL;
...
parameter_types! {
	...
	pub const AllyDeposit: Balance = 10 * SMPL;
...
parameter_types! {
	pub StatementCost: Balance = 1 * SMPL;
...
pub mod dynamic_params {
	...
	pub mod storage {
		...
		#[codec(index = 0)]
		pub static BaseDeposit: Balance = 1 * SMPL;
